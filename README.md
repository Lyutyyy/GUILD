...
## Установка и запуск
### 1. Подготовка
Установите исходный код проекта в удобное для вас место.

Убедитесь, что у вас установлен Python. Проверить версию можно командой в терминале:
```python
python --version
```
После выполнения команды вы должны увидеть версию языка (Пример: `Python 3.14.4`). Если увидели ошибку, то установите Python.
